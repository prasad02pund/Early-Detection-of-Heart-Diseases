...
if (isset($_GET['data'])) {
    ...
    $bmi = $receivedData[9];
    $bp = $receivedData[10];
    $heartrate = $receivedData[11];
    $acidity = $receivedData[12];
    $obesity = $receivedData[13];
    $asthma = $receivedData[14];
    $smoking = $receivedData[15];
    $alcohol = $receivedData[16];
    $fastbreathing = $receivedData[17];
    $foodschedule = $receivedData[18];
    $sleepingschedule = $receivedData[19];
    $hypertension = $receivedData[20];
    $hearthistory = $receivedData[21];
    $stresslevel = $receivedData[22];
    $output = $receivedData[23];
    $responseAI = "";
    //$responseAI = $receivedData[24];
}
?>
...
<body>
    ...
    <div class="container mt-4" id="health-report">
        ...
        <div class="row">
            ...
            <div class="col-md-6"><strong>Fast Breathing During Walking:</strong> <?php echo $fastbreathing ?></div>
            <div class="col-md-6"><strong>Food Schedule:</strong> <?php echo $foodschedule ?></div>
